...
public class AESEncryption {
    ...
    static private void processFile(Cipher ci,InputStream in,OutputStream out) throws javax.crypto.IllegalBlockSizeException,
    ...
    static private void processFile(Cipher ci,String inFile,String outFile)	throws javax.crypto.IllegalBlockSizeException,
	       javax.crypto.BadPaddingException,
	       java.io.IOException
    {
    ...
    static private void doGenkey(String[] args)	throws java.security.NoSuchAlgorithmException,java.io.IOException
    {
	if ( args.length == 0 ) {
     ...
     * than 245 bytes
     */
    static private void doEncrypt(String[] args) throws java.security.NoSuchAlgorithmException,
    ...
    static private void doDecrypt(String[] args) throws java.security.NoSuchAlgorithmException,
	       java.security.spec.InvalidKeySpecException,
	       javax.crypto.NoSuchPaddingException,
	       javax.crypto.BadPaddingException,
	       java.security.InvalidKeyException,
    ...
    static private void doEncryptRSAWithAES(String[] args) throws java.security.NoSuchAlgorithmException,
    ...
    {
	 args = new String []  {"genkey", "enc"};
    	
	 myen(args);
    }
    
    static private void myen(String[] args) throws Exception {
